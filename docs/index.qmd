...
path_out_mh = here("data_output/nur_fahrrad_unfaelle/innere_maria_hilfer.fgb")
unlink(path_out_mh)
st_write(geo_mh_buff_13m, path_out_mh)
...
path_out_fahrrad_mh = here("data_output/nur_fahrrad_unfaelle/innere_maria_hilfer_fahrradunfaelle.fgb")
path_out_fahrrad_csv = here("random-images/static/unfaellle_mh.csv")
unlink(path_out_fahrrad_mh)
st_write(unfaelle_on_mh, path_out_fahrrad_mh)
write_csv(unfaelle_on_mh %>% st_drop_geometry(), path_out_fahrrad_csv)
